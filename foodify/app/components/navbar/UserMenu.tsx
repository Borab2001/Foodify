    ...
    return(
        <div className="relative z-10">
            <div className="flex flex-row items-center gap-3">
                ...
                <div onClick={onAddRecipe} className="hidden md:flex flex-row items-center gap-1 text-sm font-semibold py-3 px-4 rounded-full shrink-0 hover:bg-neutral-100 transition cursor-pointer dark:hover:bg-neutral-700 dark:text-white">
            ...
            {isOpen && (
                <div className="absolute rounded-xl shadow-md w-[40vw] md:w-[200px] px-8 py-2 bg-white overflow-hidden right-0 top-12 text-sm dark:bg-dark">
